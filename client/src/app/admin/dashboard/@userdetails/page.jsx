...
export default function UserDetails({ totalUsers, newUserCount }) {
  ...
  return (
    <div className="w-[40%] flex flex-wrap h-[30%] mt-5 mb-8 rounded-2xl ">
      <UserDetailsCard
        color={"#7762b1"}
        className={"border-b-[1px] border-r-[1px] rounded-tl-lg"}
        title={"Total User"}
        value={totalUsers}
      />
      <UserDetailsCard
        color={"#181b26"}
        className={"border-b-[1px] border-l-[1px] rounded-tr-lg"}
        title={"Total Post"}
        value={"20"}
      />
      <UserDetailsCard
        color={"#181b26"}
        className={"border-t-[1px] border-r-[1px] rounded-bl-lg"}
        title={"New User"}
        value={newUserCount}
      />
      <UserDetailsCard
        color={"#181b26"}
        className={"border-t-[1px] border-l-[1px] rounded-br-lg"}
        title={"Premium Users"}
        value={"10"}
      />
    </div>
...
export function UserDetailsCard({ color, className, title, value }) {
  return (
    <div
      className={`w-[50%] h-[50%] border-x-cc-color ${className} flex`}
